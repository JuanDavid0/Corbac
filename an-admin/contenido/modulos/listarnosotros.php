...
$registros = Galeria::listarGaleria('galeria', 112, 'nosotros');
$registros2 = Galeria::listarGaleria('galeria', 176, 'nosotros');
?>
<div id="contenedor-AreaTrabajo-Admin">        
    <div class="contenedor-Agregar-personas">        
        <a class="ico-agregar Agregar-persona" href="<?php echo $rutaFinal;?>registronosotrosadmin">Crear</a>                      
    </div>
    <div id="contenedorRespuesta" class="contenedorRespuesta">
        <div id="confirmeEliminar" class="confirmar">
            ...
            <div class="alerta-titulo alerta-error-color1">¿Realmente desea eliminar este registro?</div>
    ...
    <div id="contenedor-personas-admin">
        ...
        foreach ($registros as $indice => $campo) {       
           $xhtml .= "<div class=\"contenedor-persona-admin\">"; 
            $xhtml .= "<p class=\"tit-persona-admin img-banner-admin\" style=\"background-image:url('".$rutaFinal."contenido/assets/".$campo['imagen_p']."');\"></p>";
           $xhtml .= "<p class=\"tit-persona-admin\">".$campo['nombre']."</p>";                       
           $xhtml .= "<p class=\"tit-persona-admin\">";
           $xhtml .= "<a title=\"Editar\" class=\"log-persona-admin log-persona-ed fa-editar\" href=\"".$rutaFinal."editarregistronosotros/".$campo['identificador']."\"></a>"; 
