...
$correoF = Usuario::buscarusuario('log_adminx',$usuario);
?>
...
<div id="contenedor-AreaTrabjo-Admin">
    ...
    <div id="AreaTrabjo-Admin-cont">
        ...
        <form id="contenedor-form-Admin" method="POST" action="<?php echo $rutaFinal ?>contenido/ajax/ajaxUsuario.php" enctype="multipart/form-data">                                          
            ...
            <input name="contrasena" class="input-form-act-admin" type="password" value="<?php echo $correoF['telefono']; ?>">             
            <label class="label-form-act-admin">Estado</label>
            <select name="estado" class="input-form-act-admin">
                <option value="Activo" <?php if($correoF['estado'] === 'Activo' ){  echo 'selected=""' ;}?>>Activo</option>
