...
$registros = $objDistribuidores->listar();
?>
<div id="contenedor-AreaTrabajo-Admin">        
    <div class="contenedor-Agregar-personas">        
        <a class="ico-agregar Agregar-persona" href="<?php echo $rutaFinal;?>registrardistribuidor">Nuevo</a>                      
    ...
    <div id="contenedorRespuesta" class="contenedorRespuesta">
        <div id="confirmeEliminar" class="confirmar">
            ...
            <div class="alerta-titulo alerta-error-color1">¿Realmente desea eliminar este distribuidor?</div>
    ...
    <div id="contenedor-personas-admin">
        ...
        if($xhtml !== ""){ echo $xhtml; }else{ echo "Aun no hay distribuidores registrados"; }
?>
    </div>    
</div>      