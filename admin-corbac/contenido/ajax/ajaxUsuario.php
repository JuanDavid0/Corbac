...
if ($accion == "crear") {
    ...
    $contrasena_aux = filter_input(INPUT_POST, 'contrasena', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
...
if ($accion == "editar") {
    $usuario = new Usuario();
    $usuario->correo_p = filter_input(INPUT_POST, 'correo_p', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $contrasena_p_aux = filter_input(INPUT_POST, 'contrasena', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $usuario->estado = filter_input(INPUT_POST, 'estado', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    if ($contrasena_p_aux == '') {
...
if ($accion == "eliminar") {
    $usuario = new Usuario();
    $usuario->correo_p = filter_input(INPUT_GET, 'id', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
