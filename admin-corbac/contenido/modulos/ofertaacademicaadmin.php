...
<div id="contenedor-AreaTrabajo-Admin">
    <div class="contenedor-Agregar-personas">
        <a class="ico-agregar Agregar-persona" href="<?php echo $rutaFinal; ?>crearofertaacademica">Crear</a>
    </div>
    ...
    <div id="contenedor-personas-admin">
        ...
        foreach ($registros as $indice => $campo) {
            ...
            $xhtml .= "<a title=\"Editar\" class=\"log-persona-admin log-persona-ed fa-editar\" href=\"" . $rutaFinal . "editarofertaacademica/" . $campo['identificador'] . "\"></a>";
